                   ...
                   size_t nargsf, PyObject *kwnames)
{
    ...
    if (!pto_nkwds) {
        ...
        if (nkwds) {
            ...
            ptr_wise_atomic_memcpy(*stack, stack + tot_nargs, args + nargs, nkwds);
        }
    }
    else {
    ...
    if (pto_phcount) {
        ...
        ptr_wise_atomic_memcpy(stack, stack, pto_args, pto_nargs);
        ptr_wise_atomic_memcpy(stack, stack + pto_nargs, args, nargs);
    }
